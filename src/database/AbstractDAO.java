...
public abstract class AbstractDAO {
	...
	protected Student getStudent(Integer id) {
	...
	protected Project getProject(int idProject) {
	...
	protected Team getTeam(int idstudent1, int idstudent2, int idProject) {
	...
	protected Grade getGrade(int idstudent1, int idstudent2, int idProject) {
	...
	public Program getProgram(Integer idProgram) {
		...
		Promo promo = Promo.valueOf(resultSet.getString("promo"));
